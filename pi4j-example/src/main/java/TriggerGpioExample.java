...
public class TriggerGpioExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final GpioPinDigitalInput myButton = gpio.provisionDigitalInputPin(RaspiPin.GPIO_01);
        ...
        GpioPinDigitalOutput myLed[] = {
            gpio.provisionDigitalOutputPin(RaspiPin.GPIO_07, "LED #1", PinState.HIGH),
            gpio.provisionDigitalOutputPin(RaspiPin.GPIO_00, "LED #2", PinState.HIGH),
            gpio.provisionDigitalOutputPin(RaspiPin.GPIO_02, "LED #3", PinState.HIGH)
          };
        ...
        myButton.addTrigger(new GpioPulseStateTrigger(PinState.LOW, myLed[2], 1000));
